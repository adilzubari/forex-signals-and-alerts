...
function PrivacyPolicy({ navigation }) {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.p}>
        Forex signals and alerts built the Forex signals app as a Freemium app.
        This SERVICE is provided by Forex signals and alters at no cost and is
      ...
      <Text style={styles.p}>
        ...
        Terms and Conditions, which are accessible at Forex signals unless
        otherwise defined in this Privacy Policy.
      </Text>
      <Text style={styles.h}>Information Collection and Use</Text>
      <Text style={styles.p}>
      ...
      <Text style={styles.p}>
        1 - Google Play Services{"\n"}2 - AdMob{"\n"}3 - Google Analytics for
        Firebase{"\n"}4 - Firebase Crashlytics{"\n"}5 - Facebook
        {"\n"}
      </Text>
      <Text style={styles.h}>Log Data</Text>
      <Text style={styles.p}>
      ...
      <Text style={styles.h}>Cookies</Text>
      <Text style={styles.p}>
      ...
      <Text style={styles.h}>Links to Other Sites</Text>
      <Text style={styles.p}>
      ...
      <Text style={styles.h}>Changes to This Privacy Policy</Text>
      <Text style={styles.p}>
        We may update our Privacy Policy from time to time. Thus, you are
        advised to review this page periodically for any changes. We will notify
        you of any changes by posting the new Privacy Policy on this page.
      </Text>
      <Text style={styles.p}>This policy is effective as of 2022-01-16</Text>
    </ScrollView>
  );
}
